...
def handle_reddit_command(args, config):
    ...
    output_filename_base = args.output_file
    ...
    if output_filename_base is None:
        ...
        output_filename_base = f"{base_name}_reddit_{timestamp}"
...
def handle_youtube_command(args, config):
    ...
    if output_filename_base is None:
        ...
        output_filename_base = f"{base_name}_youtube_{sub_type}_{timestamp}"
